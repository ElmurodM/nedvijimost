<?php
/**
 * Real Home Font Awesome Icons
 *
 * @package Real_Home
 */

class Real_Home_Font_Awesome_Icons {
    /**
     * Font Awesome Icons
     *
     * @access public
    ...
    public static function get_icon( $group, $icon ) {
        ...
        /**
         * Filters Real Home array of icons.
         *
         ...
         */
        $arr = apply_filters( "real_home_font_awesome_icons_{$group}", $arr );
		...
		echo apply_filters( 'real_home_get_font_awesome_icon', $output ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    }
}
