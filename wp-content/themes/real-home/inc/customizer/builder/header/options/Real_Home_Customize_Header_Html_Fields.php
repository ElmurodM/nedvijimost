<?php
/**
 * Real Home Theme Customizer Header HTML settings
 *
 * @package Real_Home
 */

class Real_Home_Customize_Header_Html_Fields extends Real_Home_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Grouping Settings
            'real_home_header_html_group_settings' => [
                'type'              => 'group',
                'section'           => 'html',
                'priority'          => 10,
                'choices'           => [
...
new Real_Home_Customize_Header_Html_Fields();
