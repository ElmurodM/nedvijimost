<?php
/**
 * Real Home Theme Customizer Header Main Row settings
 *
 * @package Real_Home
 */

class Real_Home_Customize_Header_Main_Row_Fields extends Real_Home_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
			...
			'real_home_header_main_row_height' => [
				...
				'description'       => esc_html__( 'To set Min Height at the main row of Header.', 'real-home' ),
				'section'           => 'real_home_header_main',
				'priority'          => 15,
...
new Real_Home_Customize_Header_Main_Row_Fields();
