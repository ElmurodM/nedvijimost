...
/**
 * Real_Home_Customize_Multi_Select_Control class
 */
class Real_Home_Customize_Multi_Select_Control extends Real_Home_Customize_Base_Control {
     ...
     * @var    string
     */
    public $type = 'real_home_multi_select';
...
$wp_customize->register_control_type( 'Real_Home_Customize_Multi_Select_Control' );