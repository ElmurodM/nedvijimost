<?php
/**
 * Real Home Theme Customizer Blog Post Featured Image settings
 *
 * @package Real_Home
 */

class Real_Home_Customize_Blog_Post_Featured_Image_Fields extends Real_Home_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Image Ratio
            'real_home_blog_post_featured_image_ratio' => [
                'type'              => 'buttonset',
                ...
                'description'       => esc_html__( 'Set custom aspect ratio for featured image. Choose proper aspects for better appearance.', 'real-home' ),
                'section'           => 'real_home_blog_post_featured_image_section',
                'priority'          => 15,
                'choices' 			=> array(
            ...
            // Image Size
            'real_home_blog_post_featured_image_size' => [
                'type'              => 'buttonset',
...
new Real_Home_Customize_Blog_Post_Featured_Image_Fields();
