<?php
/**
 * Real Home Theme Customizer Single Page Title settings
 *
 * @package Real_Home
 */

class Real_Home_Customize_Single_Page_Title_Fields extends Real_Home_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            ...
            'real_home_single_page_title_tag' => [
                ...
                'section'           => 'real_home_single_page_title_section',
                'priority'          => 15,
                'choices' 			=> array(
...
new Real_Home_Customize_Single_Page_Title_Fields();
