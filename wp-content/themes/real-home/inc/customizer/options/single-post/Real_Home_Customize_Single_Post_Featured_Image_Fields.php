<?php
/**
 * Real Home Theme Customizer Single Post Featured Image settings
 *
 * @package Real_Home
 */

class Real_Home_Customize_Single_Post_Featured_Image_Fields extends Real_Home_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Image Ratio
            'real_home_single_post_featured_image_ratio' => [
                'type'              => 'buttonset',
                ...
                'section'           => 'real_home_single_post_featured_image_section',
                'priority'          => 15,
                'choices' 			=> array(
            ...
            // Image Size
            'real_home_single_post_featured_image_size' => [
                'type'              => 'buttonset',
...
new Real_Home_Customize_Single_Post_Featured_Image_Fields();
